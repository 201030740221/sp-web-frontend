# tofishes
# 售后服务相关页面功能
define ['Checkbox', 'SelectBox', 'Amount', 'PlaceSelector_v2', 'liteModalBox', 'uploader', 'validate'], ( Checkbox, SelectBox, Amount, Places, LiteModalBox)->
    # 获取七牛图片的缩略图
    ...
    */
    ...
    page.init = ->
        ...
        $applyForm = $('#cs-order-apply-form')
        applyValidator = $applyForm.validate();

        $applyForm.on 'submit', ->
            params = $applyForm.paramMap()
            if !params.district_id
                applyValidator.showErrors
                    'address': '请选择城市行政区'
                return false
        ...
        isUploading = false
        picCountMax = 5
        upload_url =  SP.config.host + '/api/attachment/upload'
