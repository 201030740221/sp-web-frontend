# 下拉选择框 SelectBox
define ['./tpl-new-address.hbs','Validator','PlaceSelector_v2','Placeholder'], (newAddressTpl, Validator, PlaceSelector_v2, Placeholder)->
    name = 'newAddress'
    #API
    host = SP.config.host
    ...
    class NewAddress
        ...
        _initPlaceSelector : ()->
            ...
            @placeSelector = new PlaceSelector_v2
                target: @$container.find ".j-place-selector"
                mode: 2,
                onchange: (data)->
                    console.log data, '.......'
        ...
        save: ()->
            ...
            if success
                ...
                postData = $.extend _this.options.data,
                    ...
                    # is_default: _this.options.first ? 1 : 0
                if _this.options.type is 'create'
                    ...
                    postData.id = _this.options.data.id
                    postData.status = 1
                    postData.order_no = _this.options.order_no

                if _this.options.first
